...
if __name__ == "__main__":
    ...
    endpoint_device = "20:11:00:01:00:00:00:00:00:00:00:00:00:00:00:01"  #https://datatracker.ietf.org/doc/html/draft-ietf-idr-segment-routing-te-policy-16#section-2.3
    color = 100
    target_device = "1.1.1.1"  # intended head-ends for the advertised SR Policy update
    bsid_value = 100010  # bsid
    sid_list = [10200, 10300]  # label stack [10200(S=0), 10300(S=1)]
    go_bgp_subnet(
        color,
