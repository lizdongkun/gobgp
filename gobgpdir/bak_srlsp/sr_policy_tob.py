...
if __name__ == "__main__":
    ...
    endpoint_device = "100.1.13.3"  # https://datatracker.ietf.org/doc/html/draft-ietf-idr-segment-routing-te-policy-16#section-2.3
    color = 100
    target_device = "192.168.1.1"  # intended head-ends for the advertised SR Policy update
    bsid_value = 300004  # bsid
    sid_list = [1000030, 1000040]  # label stack
    go_bgp_subnet(
        color,
