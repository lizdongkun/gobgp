...
if __name__ == "__main__":
    ...
    endpoint_device = "00:06:00:01:00:00:00:00:00:00:00:00:00:00:00:01"  #https://datatracker.ietf.org/doc/html/draft-ietf-idr-segment-routing-te-policy-16#section-2.3
    color = 100
    target_device = "1.1.1.1"  # intended head-ends for the advertised SR Policy update
    bsid_value = 1020202  # bsid
    sid_list = [116001,136001,196001,104,105,106,107,108]  # label stack [10200(S=0), 10300(S=1)]
    go_bgp_subnet(
        color,
